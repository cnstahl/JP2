...
The previous analysis divides the space into tuplets of energy eigenstates with at most 4 members. See figure~\ref{fig:tuplets}. All tuplets contain an even number of states, except for some of the ground state tuplets. All even tuplets contain an equal number of fermionic and bosonic states. This shows that the supersymmetry is unbroken, as described in subsection~\ref{sub:susy}.
\begin{figure}
	\centering 
